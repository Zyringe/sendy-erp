-- 106_customer_contact_note.rollback.sql
-- Reverse mig 106. Restore the mig-104 audit trigger (fax/nickname, no contact_note) FIRST,
-- then drop the columns. Requires SQLite 3.35+ for DROP COLUMN (dev + Railway run 3.51).
...
ALTER TABLE customer_contact_review DROP COLUMN proposed_note;
ALTER TABLE customers DROP COLUMN contact_note;
