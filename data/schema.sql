...
CREATE TABLE audit_log (
    ...
    created_at      TEXT    NOT NULL DEFAULT (datetime('now','localtime'))
, row_key TEXT, change_source TEXT, change_reason TEXT);
...
CREATE TABLE pending_product_suggestions (
    ...
    created_at          TEXT    NOT NULL DEFAULT (datetime('now','localtime')),
    reviewed_at         TEXT
, brand_other_name      TEXT, color_code_other      TEXT, packaging_other       TEXT, bsn_unit              TEXT, unit_conversion_ratio REAL, sub_category TEXT, sub_category_short_code TEXT, category_id INTEGER REFERENCES categories(id), clone_source_pid INTEGER REFERENCES products(id), brand_other_short_code TEXT, brand_other_name_th TEXT);
...
CREATE TABLE purchase_transactions (
    ...
    net                 REAL,
    created_at          TEXT NOT NULL DEFAULT (datetime('now','localtime'))
, synced_to_stock INTEGER NOT NULL DEFAULT 0, doc_base TEXT, supplier_id INTEGER REFERENCES suppliers(id), line_seq INTEGER NOT NULL DEFAULT 1, change_source TEXT, change_actor TEXT, change_reason TEXT, change_token TEXT);
...
CREATE TABLE sales_transactions (
    ...
    net                 REAL,
    created_at          TEXT NOT NULL DEFAULT (datetime('now','localtime'))
, synced_to_stock INTEGER NOT NULL DEFAULT 0, doc_base TEXT, ref_invoice TEXT, change_source TEXT, change_actor TEXT, change_reason TEXT, change_token TEXT);
...
CREATE INDEX idx_ar_outstanding_due
