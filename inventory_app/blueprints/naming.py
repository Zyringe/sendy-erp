...
def _editor_options(conn):
    ...
    return {
        'brand_opts': form_options.brands(conn),
        'color_opts': form_options.colors(conn),
        'packaging_opts': form_options.packaging(),
        'condition_opts': form_options.conditions(conn),
    }
